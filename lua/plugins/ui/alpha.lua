return {
 ...
 ██████   ██  ███████████████   ██ █████████████████]]
		...
		dashboard.section.buttons.val = {
			...
			custom_button("<SPACE>m", "  File Explorer"),
			custom_button("<SPACE>r", "  Recently Opened Files"),
			custom_button("<SPACE>f", "  Search File"),
			custom_button("<SPACE>/", "󰈞  Search Contents"),
			custom_button("<SPACE>k", "  List Keymaps"),
			custom_button("<SPACE>s", "  List Sessions"),
			custom_button("<SPACE>p", "󰘳  Run Command"),
			custom_button("<SPACE>P", "  List Plugin Status"),
			custom_button("<SPACE>v", "  List Vim Options"),
			custom_button("<SPACE>n", "󰍩  List Messages"),
			custom_button("<SPACE>N", "󰍢  List Notifications"),
			custom_button("<SPACE>h", "󰞋  Find Help"),
